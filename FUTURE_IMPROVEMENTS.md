...
### 2. Sensor de Proximidade / Sleep Mode - [DONE]
...
### 5. Atualização do LVGL (v9.3 -> v9.5) - [PLANNED]
...
- Opção de alterar o tamanho das fontes de texto
- Colocar uma imagem de welcome/start quando liga o aparelho
- Melhorar os controles da barra inferior

### 7. Integração com Home Assistant
